...
public interface Search {
    ...
    ElasticSearchBase.SearchResult<FeatureCollectionGeoJSON>searchFeatureSummary(String collectionId, List<String> properties, String filter) throws Exception;
