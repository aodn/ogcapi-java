...
import au.org.aodn.ogcapi.server.core.http.HttpCacheControlInterceptor;
...
public class CustomWebMvcConfigurer implements WebMvcConfigurer {
    ...
    private final HttpCacheControlInterceptor httpCacheControlInterceptor;

    public CustomWebMvcConfigurer(HttpCacheControlInterceptor httpCacheControlInterceptor) {
        this.httpCacheControlInterceptor = httpCacheControlInterceptor;
    }
    /**
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(httpCacheControlInterceptor);
    }
}
